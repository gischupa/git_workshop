...
ausreichend langer ssh-Schlüssel benötigt. Die üblichen 2048 Bit 
genügen hier nicht! Dieser *Deploy-Key* wird später dann über die 
graphische Benutzeroberfläche in *Gitea* eingefügt (s.u.).
...
Der Inhalt von \datei{gitea\_rsa.pub} kann durch folgenden Befehl
...
![](bilder/inst/key1.png){width=30%}
![](bilder/inst/key2.png){width=30%}
![](bilder/inst/key3.png){width=30%}
