...
lediglich eine Basisinstallation! Für komplexere Szenarien führt 
...
\samplestart
**Hinweis**  
Da unklar ist, wie hier im Schulungszentrum die Vergabe der IP-Adressen erfolgt,
habe ich einen separaten Leitfaden erstellt um das Ubuntu als virtuelle Maschine 
gewissermaßen *unsichtbar* in einem versteckten Netz des Servers zu installieren.
Leider sind dafür einige Änderungen am Proxmox nötig, die ich im Anhang zusammengefasst
habe. Die Anleitung befindet sich auch als eigenständiges Dokument im Material 
(Ordner \ordner{material/proxmox).

Im Rahmen dieser Anleitung wird auch gleich das iso-Image der aktuelle Ubuntu-Version
an den richtigen Ort des Proxmox kopiert. Das Handout geht ab hier aber wieder vom 
regulären Ablauf aus.
\sampleend
