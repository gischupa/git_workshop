...
\bxlarge
```{.bash include="src/docker/docker_install_schmal.sh"}
```
\exlarge 
...
Anleitung, wie man das ändert. Im Prinzip muss nur ein weiterer
Benutzer angelegt und den richtigen Gruppen zugeordnet werden.
