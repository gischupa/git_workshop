...
Es gibt einen Grund, warum ich dir diesen Umweg zumutet habe!
Du siehst hier ein grundlegendes Konzept von \git, das beim 
Verständnis hilft:
...
verbirgt sich ein *blob*, also ein Dateisystem-Objekt aus reinen *Roh*daten **ohne** Dateinamen.  
