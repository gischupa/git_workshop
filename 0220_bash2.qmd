...
weil sie auch bereits im ersten *Hands On* verwendet wurden.
...
mkdir fortbildung
cd fortbildung
git clone https://TODO    storyvorlagen # Ziel: vorlage.git 
cd vorlage
```
...
Öffne im Fortbildungsordner eine \git-Bash und erstelle
...
Falls in der Ausgabe der Branch *master* erscheint, bitte 
umbenennen mit \cmd{git branch -m main}

Im Ordner *fortbildungen* sollten nun also die Repositories *storyvorlagen* 
und *buch* vorliegen.
...
* Checke den richtigen Stand aus: \cmd{git checkout Step_2}
...
* Checke den richtigen Stand aus: \cmd{git checkout Step_3}
...
* Im Buch-Ordner: \cmd{git switch story_2_idee_1}
* Wechsle in den Vorlagenordner
* Checke den richtigen Stand aus: \cmd{git checkout Step_4}
* Kopiere die Datei: \cmd{cp story2.md ../buch/}
...
* Im Buch-Ordner: \cmd{git switch story_2_idee_2}
* Wechsle in den Vorlagenordner
* Checke den richtigen Stand aus: \cmd{git checkout Step_5}
* Kopiere die Datei: \cmd{cp story2.md ../buch/}
* Wechsle in den Buch-Ordner
* \cmd{git add story2.md}
...
* \cmd{git checkout Step_6}
* \cmd{cp story2.md ../buch/}

* Im Buch-Ordner (aktueller Branch ist *entwicklung_story_2*)
* \cmd{git add story2.md}
* \cmd{git commit -m "typo 'weiße' korrigiert"}

Beachte, dass diese Änderung in den anderen Branches *nicht* ankommt!
