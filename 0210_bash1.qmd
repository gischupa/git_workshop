...
verwendest du     
wieder das Repository \ordner{versuch\_1}.
\sampleend
...
*Logische Bereiche* bedeutet in diesem Zusammenhang, dass sie 
von \git verwaltet werden und vom unbedarften 
...
Diese Dateien sind nun zum Commit vorgemerkt, also zum festen Eintrag in die Projekthistorie -- Das führst du jetzt aber **noch nicht aus**!
...
Bitte installiere dir in \gitbash das Programm *tree*, um den 
...
Die eigentlichen Dateiinhalte (=Blobs) sind an anderer Stelle abgelegt.
...
Über ein erneutes `tree .git` siehst du erste Änderungen im *.git*-Ordner.
