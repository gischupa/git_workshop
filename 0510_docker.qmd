...
möglich, auf einem physikalischen Server viele virtuelle Server zu erstellen. 
Sie können dann miteinander kommunizieren und Daten austauschen, du kannst sie 
aber auch über das Internet zugänglich. Es ist auf diese Weise also kein
...
Von einem Image kann man dann beliebig viele Instanzen erzeugen, die auch 
fast ohne Zeitverlust startbar sind. Der längste Teil ist der Download des Image.
