...
Projekt ein kleines Buch mit Kurzgeschichten.
...
\samplestart
**Hinweis**  
Als Alternative zum Clonen kann der aktuelle Stand des Repositories 
auch als zip-Datei heruntergeladen und entpackt werden. Das bietet 
sich auch für die Bereitstellung von Material an, wenn auf den 
Computern **kein** \git installiert ist.
\sampleend

## Labor
Es dürfte am einfachsten sein, wenn du zwei Terminals öffnest: 

* Eines für das Repository des *Vorlagenordners*
* Eines für das Repository des *Arbeitsordners*
