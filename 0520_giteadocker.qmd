...
3. Die Daten von Gitea liegen im Ordner \datei{gitea_data},
   genauer unter \datei{/var/lib/docker/volumes/gitea_data}.
...
4. Ein Volume kann auch nur eine einzige Datei sein. Beachte
   ...
   \datei{gitea_runner_data}. Das *./* am Anfang bedeutet, dass diese 
