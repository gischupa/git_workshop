...
Es handelt sich um ein öffentliches Repository, auf das auch ohne Benutzerkennung zugegriffen werden darf -- aber eben nur lesend. Aus diesem Grund wird zum Clonen auch *https* und nicht *ssh* verwendet.
...
in der Anleitung entstehen würden. Leider ist das nicht möglich,
...
umbenennen mit `git branch -m main`
...
kopierst (wil wir nicht schreiben).
...
Da wir nur kopieren und dicht schreiben, heißt das für dich:  

* Im Buch-ordner: `git switch story_2_idee_1`
* Wechsle in den Vorlagen-Ordner
* Richtigen Stand auschecken: `git checkout Step_4`
* Kopieren der Datei: `cp story2.md ../buch/`
* Wechsel in Buch-Ordner
* `git add story2.md`
...
* Im Buch-Ordner: `git switch story_2_idee_2`
* Wechsle in den Vorlagenordner
* Richtigen Stand auschecken: `git checkout Step_5`
* Kopieren der Datei: `cp story2.md ../buch/`
* Wechsel in den Buch-Ordner
* `git add story2.md`
