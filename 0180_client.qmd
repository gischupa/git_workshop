...
Client und Server installiert. Du wirst hier aber 
nur den Client (=\git-Bash) verwenden.  
Dabei handelt es sich um eine extrem abgespeckte 
...
Lade von [notepad-plus-plus.org](https://notepad-plus-plus.org/downloads/) den Editor *notepad++* herunter und installiere das 
...
Du kannst die \git-Bash aus dem Explorer heraus im 
gewünschten Ordner (z.B. Projektordner) öffnen.
