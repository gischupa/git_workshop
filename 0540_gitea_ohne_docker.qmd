...
Die Befehle müssen nicht per Hand eingegeben werden. Das dient lediglich der 
Dokumentation. Die Scripte \script{setup\_gitea.sh} 
und \script{tune.sh} müssen als *root* bzw. über *sudo* ausgeführt werden.

**setup\_gitea.sh**  
```{.bash include=src/gitea/setup_gitea.sh}
```
