...
Projektordner sein!^[Sollte dir still
die Schrift im Fentser zu klein sein,
...
Hinweis: Dieser Standard-Branchname kann sich ändern.
Hinweis: Um den Namen des initialen Branches zu konfigurieren,
Hinweis: der in allen neuen Repositories verwendet werden soll und
...
\samplestart 
**Hinweis**  
Du kannst \git auch so konfigurieren, dass der Branch eines 
...
gehören. Es wäre dann etwas unübersichtlich, wenn  
...
spezielle Varianten, die wir nicht behandeln! 
\sampleend
