...
```{.bash include="src/11_team_hands_on/susi_und_max.sh"}
```
...
To 192.168.3.190:/home/benutzer/entfernt.git
...
Von 192.168.3.190:/home/benutzer/entfernt.git
...
```{.bash include="src/11_team_hands_on/max_error.sh"}
```
...
error: Fehler beim Versenden einiger Referenzen 
        nach '192.168.3.190:/home/benutzer/entfernt.git'
