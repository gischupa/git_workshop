...
bei Dingen, wo ich nicht so fit bin. Dann nehme ich ein vorhandenes 
...
und dass es eine `HEAD` gibt, der auf `main` zeigt. Das ist wichtig,
denn *zeigen* ist genau das benötigte Verb. Bei `HEAD` handelt es 
sich um einen Zeiger (Pointer), der auf `main` zeigt. Das haben 
...
![](bilder/branch_lab/mainbranch.png)
...
commit 7c5a5851fcb062c07a9b99195e33b97ee5353ab0 (HEAD -> spielplatz, main)
Author: Wolfgang <hoeferwolf@t-online.de>
...
dort arbeitet und danach das Ergebnis direkt wieder in den Branch \branch{main}
übernimmt. Dieser Vorgang wird *fast Forward (ff)* genannt, weil hier 
eigentlich gar nichts passiert, außer dass die Pointer passend umgeschrieben werden.


TODO: BILD, wann welcher Pointer wo ist

Eine typische Fehlvorstellung ist es, dass *Branchig* sofort eine Abzweigung
